    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    inputs[handle].value = 10 * values[handle] / 10;
                }));
        ...
        function initSliders() {
            ...
            if (document.querySelector(".item__slider")) {
                let thumb = new core(".item-thumb__slider", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
...
***************************************************************************** */
        ...
        if (collapse) if (document.documentElement.clientWidth > 991) collapse.classList.add("_spoller-active");
